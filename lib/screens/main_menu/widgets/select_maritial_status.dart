...
class SelectMaritialStatus extends StatelessWidget {
  const SelectMaritialStatus({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...options.map((option) {
            bool isSelected = logic.state.selectedMaritalStatus == option;

            return ListTile(
              onTap: () {
                logic.state.selectedMaritalStatus = option;
